...
>A hands on training about Basic Usage Of GNU Octave.
...
This is an experiment which is done, routinely by XII science students. The goal is to measure *g* at the location, by measuring time periods of pendula with varying lengths. The experimental data gathered by a students is given below. Make a $l-T^2$ graph as well as estimate *g* using the data provided.	
